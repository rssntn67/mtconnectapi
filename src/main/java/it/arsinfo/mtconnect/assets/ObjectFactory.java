 ...
 * generated in the it.arsinfo.mtconnect.assets package. 
...
public class ObjectFactory {
    ...
    private final static QName _CuttingToolArchetypeTypeCuttingToolLifeCycle_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingToolLifeCycle");
    private final static QName _CuttingToolArchetypeTypeCuttingToolDefinition_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingToolDefinition");
    private final static QName _CuttingToolArchetypeTypeDescription_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "Description");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.arsinfo.mtconnect.assets
     * 
     */
    ...
    public JAXBElement<CuttingToolLifeCycleArchetypeType> createCuttingToolArchetypeTypeCuttingToolLifeCycle(CuttingToolLifeCycleArchetypeType value) {
        return new JAXBElement<CuttingToolLifeCycleArchetypeType>(_CuttingToolArchetypeTypeCuttingToolLifeCycle_QNAME, CuttingToolLifeCycleArchetypeType.class, CuttingToolArchetypeType.class, value);
    }
    ...
    public JAXBElement<CuttingToolDefinitionType> createCuttingToolArchetypeTypeCuttingToolDefinition(CuttingToolDefinitionType value) {
        return new JAXBElement<CuttingToolDefinitionType>(_CuttingToolArchetypeTypeCuttingToolDefinition_QNAME, CuttingToolDefinitionType.class, CuttingToolArchetypeType.class, value);
    }
    ...
    public JAXBElement<AssetDescriptionType> createCuttingToolArchetypeTypeDescription(AssetDescriptionType value) {
        return new JAXBElement<AssetDescriptionType>(_CuttingToolArchetypeTypeDescription_QNAME, AssetDescriptionType.class, CuttingToolArchetypeType.class, value);
    }
    ...
    public JAXBElement<CuttingToolLifeCycleType> createCuttingToolTypeCuttingToolLifeCycle(CuttingToolLifeCycleType value) {
        return new JAXBElement<CuttingToolLifeCycleType>(_CuttingToolArchetypeTypeCuttingToolLifeCycle_QNAME, CuttingToolLifeCycleType.class, CuttingToolType.class, value);
    }
    ...
    public JAXBElement<CuttingToolDefinitionType> createCuttingToolTypeCuttingToolDefinition(CuttingToolDefinitionType value) {
        return new JAXBElement<CuttingToolDefinitionType>(_CuttingToolArchetypeTypeCuttingToolDefinition_QNAME, CuttingToolDefinitionType.class, CuttingToolType.class, value);
    }
    ...
    public JAXBElement<AssetDescriptionType> createCuttingToolTypeDescription(AssetDescriptionType value) {
        return new JAXBElement<AssetDescriptionType>(_CuttingToolArchetypeTypeDescription_QNAME, AssetDescriptionType.class, CuttingToolType.class, value);
    }
